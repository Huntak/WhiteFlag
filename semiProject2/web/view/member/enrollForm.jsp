...
<meta charset="UTF-8">
<title>회원 가입</title>
<link rel="stylesheet" type="text/css" href="/semi/view/member/css/memberEnroll.css?ver=7">
<script type="text/javascript" src ="/semi/common/js/jquery-3.1.1.min.js"></script>
<script type="text/javascript"  src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script>
<script type="text/javascript" src ="/semi/common/js/commonSize.js?ver=8"></script>
<script type="text/javascript"  src="/semi/view/member/js/memberEnroll.js?ver=7"></script>
...
<header>	
		...
		<div id="center" >
			 	<form action="/semi/enroll" method="post" onsubmit="return validate();"  >
					...
					<td><input type="text" name="userName" id="userName" placeholder="2글자이상"  size="24" required>
					<label id="checkNameResult"></label>			
					</td></tr>
					<tr><td class="item"><label for="userId">아이디</label></td>
					<td><input type="text" name="userId" id="userId" placeholder="중복체크후 사용가능"  size="24" readonly  >
					
					&nbsp;<input type="button" value="중복체크" onclick="idCheck();" class="button" id="checkRepeatB">
					</td></tr>
					<tr><td class="item"><label for="userPwd">비밀번호</label></td>
					<td><input type="password" name="userPwd" id="userPwd" placeholder="영문/숫자 조합 8글자 이상"  size="24" required>
					<label for="userPwd" id="pwd"></label>
					</td></tr>
					<tr><td class="item"><label for="userPwdCheck">비밀번호확인</label></td>
					<td><input type="password" name="userPwdCheck" id="userPwdCheck" placeholder="암호다시입력"  size="24" required>
					<label for="userPwdCheck" id="checkPwdResult"></label></td></tr>
					<tr><td class="item"><label for="email">이메일</label></td>			
					<td> <input type="text" name="userEmail1"size="14" id="userEmail1" required>@<input type="text" name="userEmail2" size="10"  id="userEmail2" >   
					...
					<td><input type="radio" name="gender" id="gender1" value="M" checked>남 &nbsp; &nbsp;
					<input type="radio" name="gender" id="gender2" value="F">여</td></tr>
					<tr><td class="item"><label for="birth">주민번호6자리</label></td>
					<td><input type="text" name="birth" id="birth" size="10"  placeholder=" 840823" >
					<label for="birth" id="birthError"> </label>
					</td></tr>
					<tr><td class="item"><label for="phone">전화번호</label></td>
					<td><select id="hp1" name="hp1" >
					   <option value="02"  selected> 02 </option><option value="031"> 031 </option><option value="032"> 032 </option>
					   <option value="033"> 033 </option><option value="041"> 041 </option><option value="042"> 042 </option>
					   <option value="043"  selected> 043 </option><option value="044"> 044 </option><option value="051"> 051 </option>
					   <option value="052"> 052 </option><option value="053"> 053 </option><option value="054"> 054 </option>
					    <option value="055"  selected> 055 </option><option value="061"> 061 </option><option value="062"> 062 </option>
					...
					</select> - <input type="number" name="hp2" id="hp2" size="4"  value="" >
					- <input type="number" name="hp3" id="hp3" size="4"  value="" > 
					<label for="hp2" id ="phoneError"></label>
					</td></tr>
					<tr><td class="item"><label for="zipcode">우편번호</label></td>
			        <td><input type="text" name="post1" id="post1" size="10" maxlength="10"  readonly required >-<input type="text" name="post2" id="post2"
					...
					<br/> <br/> 
					<h4>&nbsp;&nbsp;&nbsp;&nbsp;이용약관 동의</h4> <br/> 
					<div class="surfaceProvision" style="height:220px;" >
						<div class="provision" style="height:156px;">
						제1조(목적)<br/><br/>
						이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.<br/><br/>
						
						※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」<br/><br/>
						
						제2조(정의)<br/><br/>
						①“몰” 이란 OO 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br/><br/>
						...
						① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?모사전송번호?전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 00 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br/><br/>
						...
						④ “몰”이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의 초기화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다.<br/><br/>
						...
						1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에 의한 회원자격 상실후 3년이 경과한 자로서 “몰”의 회원재가입 승낙을 얻은 경우에는 예외로 한다.<br/><br/>
						...
						1. 가입 신청시에 허위 내용을 등록한 경우<br/><br/>
						2. “몰”을 이용하여 구입한 재화등의 대금, 기타 “몰”이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우<br/><br/>
						...
						제9조(구매신청)<br/><br/>
						“몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. 단, 회원인 경우 제2호 내지 제4호의 적용을 제외할 수 있습니다.<br/><br/>
						1. 재화등의 검색 및 선택<br/><br/>
						2. 성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호) 등의 입력<br/><br/>
						...
						2. 미성년자가 담배, 주류등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우<br/><br/>
						...
						제11조(지급방법)<br/><br/>
						“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.<br/><br/>
						...
						① “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화등의 대금을 환급합니다. 이 경우 “몰”이 이용자에게 재화등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.<br/><br/>
						...
						③제공된 개인정보는 당해 이용자의 동의없이 목적외의 이용이나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 　몰　이 집니다. 다만, 다음의 경우에는 예외로 합니다.<br/><br/>
						
						1. 배송업무상 배송업체에게 배송에 필요한 최소한의 이용자의 정보(성명, 주소, 전화번호)를 알려주는 경우<br/><br/>
						2. 통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 식별할 수 없는 형태로 제공하는 경우<br/><br/>
						3. 재화등의 거래에 따른 대금정산을 위하여 필요한 경우<br/><br/>
						4. 도용방지를 위하여 본인확인에 필요한 경우<br/><br/>
						...
						부 칙(시행일) 이 약관은 년 월 일부터 시행합니다. <br/><br/>
						
						
						</div> <br/>  <br/> 
						이용약관에 동의하십니까?&nbsp; <input type="checkbox" name="agreecheckbox" id="agreeCheck1" />동의함 
						<br><br>
					</div>
					<br/><br/><br/><br/><br/><h4>&nbsp;&nbsp;&nbsp;&nbsp;개인정보 수집 및 이용 동의</h4> <br/> 
				 
					
					
					<div class="surfaceProvision" style="height:220px;" >
						<div class="provision" style="height:156px;"><br/>
						■ 수집하는 개인정보 항목<br/><br/>
						 회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br/><br/>
						ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 직업 , 회사명 , 부서 , 직책 , 회사전화번호 , 취미 , 결혼여부 , 기념일 , 법정대리인정보 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보 , 결제기록<br/><br/>
						...
						ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산 콘텐츠 제공 , 구매 및 요금 결제 , 물품배송 또는 청구지 등 발송<br/><br/>
						ο 회원 관리<br/><br/>
						...
						개인정보 수집 및 이용 동의&nbsp; <input type="checkbox" name="agreecheckbox" id="agreeCheck2"/>동의함
					</div>
				
					<div  class="surfaceEnrollbutton" > <br><label id="inforCheck"></label><br/>
					<input class="forEnroll" type="submit" value="회원가입" id="enrollButton" disabled >  &nbsp; &nbsp;
					<input class="forEnroll" type="reset" value="회원가입취소" id="cancelButton"> <br/>
			...
			<div id="confirmIdRepeat" >
			<form action="/semi/idCheck">
			<div id="confirmIdRepeattop">&nbsp;&nbsp; 아이디 중복 확인
			&nbsp;&nbsp;  <input id="exitB" type="button" value="x" onclick="exitClick()"/></div> 	
			<div id="confirmIdRepeatcenter"><br/>&nbsp;&nbsp;아이디는 영문(소문자),숫자로 5~12자 이내로 입력해 주세요 <br/> <br/>
				&nbsp;&nbsp;<input type="text" size="20"  id="confirmText"  > &nbsp; 
				<input id="confirmButton" type="button" value="중복확인"  onclick="confirmId()"  /> <br/> <br/>
				&nbsp;&nbsp;<label id="afterCheck"></label> <br/> <br/>		
			</div>
			<div id="confirmIdRepeatbottom" align="center"><hr/><input  type="button" value="사용하기" disabled id="useid" onclick="useTheId();"></div>
			</form>
