...
/**
 * Servlet implementation class ReviewToWrite
 */
@WebServlet("/reviewToWrite")
public class ReviewToWrite extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewToWrite() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*if(productList.size() > 0 && productImage != null){*/
			rd = request.getRequestDispatcher("view/reviewBoard/reviewWr.jsp");
