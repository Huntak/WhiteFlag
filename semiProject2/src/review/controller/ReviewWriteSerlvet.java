...
/**
 * Servlet implementation class ReviewWriteSerlvet
 */
@WebServlet("/rwrite")
public class ReviewWriteSerlvet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewWriteSerlvet() {
        super();
	...
	/*	boolean isMultipart = ServletFileUpload.isMultipartContent(request);
		if(!isMultipart){
			...
			//int rPassword = Integer.parseInt(mrequest.getParameter("pwd"));
			String rContent	 = mrequest.getParameter("rcontent"); //예외적으로 textarea name 가져옴
			...
			Review review = new Review(rTitle, rContent, rImage, mId, pId);
			...
			if(result > 0){
				...
				RequestDispatcher view = request.getRequestDispatcher("view/reviewBoard/reviewError.jsp");
